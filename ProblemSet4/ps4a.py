...
WORDLIST_FILENAME = "C:\\Users\\vbajaj\\LOCAL FILES\\Dev\\MITx-6.00.1x\\ProblemSet4\\words.txt"
...
def getWordScore(word, n):
    ...
    if wordLen == 0:
        ...
        letterScore = 0
        for w in word:
            letterScore += SCRABBLE_LETTER_VALUES[w]
        finalScore = letterScore * wordLen
        if wordLen == n:
            finalScore += 50
    return finalScore
